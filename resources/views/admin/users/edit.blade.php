                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <button class="btn btn-outline-primary" type="button" id="btn-send-otp" style="display: none;">Verifikasi Email Baru</button>
                                </div>
                        ...
                        <div class="col-md-12" id="otp-section" style="display: none;">
                            <div class="form-group mb-3 p-3 border rounded bg-light">
                                ...
                                <p class="small text-muted mb-2">Kode telah dikirim ke email baru. Silakan masukkan kode tersebut.</p>
                                <div class="input-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" id="nip" name="nip" class="form-control @error('nip') is-invalid @enderror" value="{{ old('nip', $user->nip) }}" placeholder="Contoh: 198001012005011001" maxlength="18" minlength="18" pattern="\d{18}" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 18)">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        btnVerifyOtp.addEventListener('click', async function() {
            ...
            try {
                ...
                const data = await response.json();
                if(data.success) {
                    otpStatus.innerHTML = '<span class="text-success fw-bold"><i class="bi bi-check-circle-fill me-1"></i> Email baru berhasil diverifikasi!</span>';
